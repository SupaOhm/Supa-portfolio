        ...
        {isCarouselView ? (
          ...
          <div className="relative">
            <div className="relative h-[600px] flex items-center justify-center">
              ...
              <button
                onClick={handlePrev}
                className="absolute left-1 sm:left-4 top-1/2 -translate-y-1/2 bg-gray-800/90 hover:bg-gray-700 text-white p-2 sm:p-4 rounded-full backdrop-blur-sm transition-all duration-200 hover:scale-110 z-40 shadow-xl"
              ...
              <button
                onClick={handleNext}
                className="absolute right-1 sm:right-4 top-1/2 -translate-y-1/2 bg-gray-800/90 hover:bg-gray-700 text-white p-2 sm:p-4 rounded-full backdrop-blur-sm transition-all duration-200 hover:scale-110 z-40 shadow-xl"
