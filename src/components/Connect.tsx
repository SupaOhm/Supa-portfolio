            ...
            >
              ...
              >
                ...
                {hoveredLink === link.name && (
                  <>
                    <div
                      className="absolute w-[280px] h-[280px] bg-gradient-to-r from-blue-400/30 via-purple-400/25 to-transparent rounded-full blur-[80px] pointer-events-none opacity-100"
                      style={{
                        left: `${smoothMousePosition.x - 140}px`,
                        top: `${smoothMousePosition.y - 140}px`,
                        transition: 'none',
                      }}
                    />
                    <div
                      className="absolute w-[160px] h-[160px] bg-gradient-to-r from-blue-300/25 to-transparent rounded-full blur-[50px] pointer-events-none opacity-100"
                      style={{
