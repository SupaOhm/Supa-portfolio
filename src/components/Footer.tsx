...
export default function Footer() {
  ...
  return (
    <footer className="py-12 px-4 sm:px-6 lg:px-8 border-t border-gray-800/50 bg-linear-to-r from-gray-900/50 via-gray-950 to-gray-900/50 backdrop-blur-xs">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="h-px bg-linear-to-r from-transparent via-gray-700/50 to-transparent" />
